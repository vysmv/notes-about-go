...
Но тут может возникнуть вопрос, зачем вообще нужны именованные возвращаемые значения, если в большинстве случаев мы потом принимаем их в переменные другими именами?
...
Здесь переменная result доступна в defer, потому что она именована.
